...
cd /root/JMTEB
export pkl_dir="/root/AIMET_ENV/tools/ruri/convert/script/result/pooling_mix"
...
for dim in "${dim_list[@]}"; do
    poetry run python -m jmteb  --embedder SentenceBertEmbedder   \
                                ...
                                --save_dir "/root/AIMET_ENV/tools/ruri/convert/script/jmteb_result/jmteb_soc_mix/dim_$dim"   \
