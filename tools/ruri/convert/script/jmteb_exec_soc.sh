...
SECONDS=0
LOG_FILE="/root/AIMET_ENV/tools/ruri/convert/script/runtime.log"
...
dataset_name_list=(nlp_journal_abs_intro nlp_journal_title_abs nlp_journal_title_intro)
...
vector_result_dir=/root/AIMET_ENV/tools/ruri/convert/script/result/vector
pooling_result_dir=/root/AIMET_ENV/tools/ruri/convert/script/result/pooling
